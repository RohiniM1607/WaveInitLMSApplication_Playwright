...
Feature: VIGNESHWARAN_M 04-09-2026 Edit Personal Information Feature
  ...
  Scenario: User successfully updates only the Full Name
    ...
    And the user clicks on the Save Changes button
    Then the Full Name should be updated successfully
    And the remaining personal information should remain unchanged
  ...
  Scenario: User cancels the personal information update
    When the user modifies one or more personal information fields
    And the user clicks on the "Cancel" button
    Then the Edit Personal Information modal should be closed
    And the original personal information should remain unchanged
