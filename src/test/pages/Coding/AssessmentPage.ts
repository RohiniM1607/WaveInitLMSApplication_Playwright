...
export class AssessmentPage extends BasePage {
    ...
    private readonly topicOrPrompt = this.page.getByPlaceholder("e.g. JavaScript array methods, Python data structures, etc.");
     private readonly numberOfProblems: Locator =
        this.page
            .locator("label")
            .filter({ hasText: "Number of Problems" })
            .locator("..")
            .locator("select");

    // Difficulty
    private readonly difficulty: Locator =
        this.page
            .locator("label")
    ...
    private readonly languages: Locator =
        this.page
            .locator("label")
            .filter({ hasText: "Languages (comma-separated)" })
            .locator("..")
            .locator("input");
    ...
    async enterAssessmentDetails(): Promise<void> {
        ...
        // await this.selectOption(this.numberOfProblems, "3");
        // await this.selectOption(this.difficulty, "easy");
        // await this.fill(this.languages, "javascript");
